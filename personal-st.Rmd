...
```{r}
#plotting movie ratings on Rotten Tomato 
data %>%
...
```{r}
#Plotting the year that a movie was released and the rotton tomato rating it received 
data %>%
...
```{r}
#Plotting a boxplot with the Ratings on Rotton Tomato, and the year the movie was released, with each boxplot representing a country 
  data %>%
